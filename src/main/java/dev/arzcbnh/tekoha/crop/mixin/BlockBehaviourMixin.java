...
public class BlockBehaviourMixin {
    ...
    private InteractionResult tekoha$rightClickHarvest(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hitResult, Operation<InteractionResult> original) {
